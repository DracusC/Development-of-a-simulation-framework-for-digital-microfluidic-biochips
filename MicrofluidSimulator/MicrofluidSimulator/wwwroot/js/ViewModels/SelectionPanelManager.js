...
let selection_manager = {
    ...
    /**
     * The function clear_selection_list will clear the DOM of the selection list
     */
    clear_selection_list: function () {
        document.querySelector("#simulatorGUI").querySelector("#selectionPanel").querySelector('form').innerHTML = "";
    },
